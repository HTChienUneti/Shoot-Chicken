...
public class EnemyShooter : ObjectShooter
{
    ...
    protected override Transform GetPrefab()
    {
        ...
        newPrefab.GetComponent<EnemyBulletCtrl>().SetShooter(transform.parent);
        return newPrefab;
    ...
    {
        return this.enemyCtrl.WeaponSO.weapons[0].name;
    }

    protected override List<WeaponSO> GetWeaponSO()
    {
        return this.enemyCtrl.WeaponSO.weapons.Cast<WeaponSO>().ToList();
    }
}
